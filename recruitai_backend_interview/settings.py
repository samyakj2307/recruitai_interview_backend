"""
Django settings for recruitai_backend_interview project.
...
ROOT_URLCONF = 'recruitai_backend_interview.urls'
...
WSGI_APPLICATION = 'recruitai_backend_interview.wsgi.application'
